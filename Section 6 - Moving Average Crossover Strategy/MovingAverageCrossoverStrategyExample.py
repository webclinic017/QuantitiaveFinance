...
class MovingAverageCrossover:
    ...
    def plot_signals(self):
        ...
        plt.plot(self.data.short_ma, label='Short MA', color='red')
        plt.plot(self.data.long_ma, label='Long MA', color='blue')
        plt.title('MICROSOFT - Moving Average (MA) Crossover Trading Strategy')
        plt.xlabel('Date')
    ...
    def plot_equity(self):
        ...
        plt.title('MICROSOFT - Moving Average Crossover Strategy Equity Curve')
        plt.xlabel('Date')
